<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {% if field.getUserOption('element') %}
                {% switch(field.getUserOption('element')) %}
                {% case 'datepicker' %}
                {{ partial(config.application.viewsDir~'contents/form-elements/datepicker', ['field': field]) }}
                {% break %}
                {% endswitch %}
                {% else %}
                {{ field }}
    ...
    <div class="box-footer">
        ...
        <button type="submit" class="btn btn-success pull-right"><i class="fa fa-floppy-o" aria-hidden="true"></i>
            Save</button>
    </div>
    <!-- /.box-footer -->
    </form>
